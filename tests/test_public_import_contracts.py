...
PUBLIC_IMPORTS = {
    ...
    "mat_viewer.cube": ("read_cube", "build_orbital_panel_figure", "export_static"),
    "mat_viewer.depth_sort": ("camera_view_vector", "assign_zorder_by_depth"),
    "mat_viewer.loader": ("LoadedCrystal", "build_bundle_scene", "build_loaded_crystal"),
    "mat_viewer.math": ("camera_screen_basis", "ellipsoid_principal_axes", "nearest_lattice_shift_frac"),
