...
PUBLIC_IMPORTS = {
    "api": ("handle_ws_message", "register_api"),
    "app": ("ViewerBackend", "create_app"),
    "crystal_viewer.api": ("handle_ws_message", "register_api"),
    "crystal_viewer.app": ("create_app", "ViewerBackend"),
    "crystal_viewer.analysis.topology": ("analyze_topology", "extract_coordination_shell"),
    ...
    "crystal_viewer.ops": ("apply_transforms", "transforms_cache_key"),
    ...
    "crystal_viewer.structure.loader": ("LoadedCrystal", "build_bundle_scene", "build_loaded_crystal"),
