...
:func:`mat_viewer.scene.build_scene_from_atoms`) and returns a
...
The ``seeds`` selector mirrors :mod:`mat_viewer.atom_groups`:
...
def resolve_seed_indices(
    ...
    The selector grammar mirrors :mod:`mat_viewer.atom_groups` so
