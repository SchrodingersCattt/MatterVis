...
try:
    ...
    from mat_viewer.style.disorder import atom_is_minor, bond_is_minor  # type: ignore
...
def _resolve_view(
    ...
    kwargs = {"compound_name": name, "weights": view_weights}
    if molcrys_analysis is not None:
        kwargs["molcrys_analysis"] = molcrys_analysis
    return ops.auto_view_dir(atoms, M, cell, **kwargs)
