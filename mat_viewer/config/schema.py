...
BUILTIN_STYLE: dict[str, Any] = {
    ...
    # Isosurface overlay for cube volumetric data
    "isosurface_enabled": True,
    "isosurface_isovalue": None,
    "isosurface_percentile": 98.5,
    "isosurface_opacity": 0.55,
    ...
    "isosurface_min_volume_voxels": 0,
    "isosurface_mode": "surface",
    "isosurface_wireframe_width": 1.0,
    "isosurface_wireframe_opacity": 1.0,
    "monochrome": False,
