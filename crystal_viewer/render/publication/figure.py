...
from .materials import _axis_camera_basis, _polyhedron_facecolors
from .style import _deep_merge, publication_config
from ..topology import _hull_simplices, representative_polyhedron_overlay
from .primitives import (
    _draw_sphere,
    _front_face_mask,
    _normalise_sectors,
    _polyhedron_geometry,
